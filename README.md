...
3. Enter the name of the city for which you want to check the weather in the provided input field.
4. Press the Enter key or click on the search button to retrieve the weather information for the specified city.
...
## Acknowledgements
- [OpenWeatherMap API](https://openweathermap.org/api): Provides weather data used in the application.
